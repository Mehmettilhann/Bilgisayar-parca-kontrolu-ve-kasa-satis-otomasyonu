...
int bakiyeSorgula() { 				//Kullanýcýnýn mevcut bakiyesini ekrana yazdýrýr ve bakiye.txt'den okur
    system("CLS");
    FILE *dosya;
...
int bakiyeEkle() {					//Kullanýcýdan eklenecek para miktarýný alýr, bakiyeyi günceller
    system("CLS");
